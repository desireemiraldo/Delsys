...
Files = {'RNW_Calçado_Confortavel_Rep_1.1',...
    ...
    'RNW_Calçado_Rapido_Rep_1.6',...
    'RNW_Calçado_Rapido_Rep_2.7',...
    'RNW_Calçado_Rapido_Rep_3.8',...
    'RNW_Calçado_Rapido_Rep_4.9',...
    'RNW_Calçado_Rapido_Rep_5.10',...
    'RNW_Calcado_Lento_Rep_1.11',...
    'RNW_Calcado_Lento_Rep_2.12',...
    'RNW_Calcado_Lento_Rep_3.13',...
    'RNW_Calcado_Lento_Rep_4.14',...
    'RNW_Calcado_Lento_Rep_6.16',...
    ...
    'RNW_Descalco_Rapido_Rep_1.23',...
    'RNW_Descalco_Rapido_Rep_2.24',...
    'RNW_Descalco_Rapido_Rep_3.25',...
    'RNW_Descalco_Rapido_Rep_4.26',...
    'RNW_Descalco_Rapido_Rep_6.28',...
    'RNW_Descalco_Lento_Rep_2.30',...
    'RNW_Descalco_Lento_Rep_3.31',...
    'RNW_Descalco_Lento_Rep_4.32',...
